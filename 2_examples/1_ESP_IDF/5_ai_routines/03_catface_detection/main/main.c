 ...
 * @file        main.c
 * @author      ALIENTEK
 * @brief       cat face detection example
...
void app_main(void)
{
    ...
    lcd_show_string(30, 70, 200, 16, 16, "CAT DETECTION TEST", RED);
    ...
    /* enable ai */
    while (esp_cat_face_detection_ai_strat())
    {
