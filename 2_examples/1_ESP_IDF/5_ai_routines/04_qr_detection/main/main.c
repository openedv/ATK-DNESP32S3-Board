 ...
 * @retval      None
 */
void lcd_qr_detection_camera(uint16_t x, uint16_t y)
{
...
void app_main(void)
{
    ...
    lcd_show_string(30, 70, 200, 16, 16, "QR DETECTION TEST", RED);
    ...
    /* enable ai */
    while (esp_qr_detection_ai_strat())
    {
