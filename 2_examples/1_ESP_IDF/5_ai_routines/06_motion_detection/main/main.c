...
void app_main(void)
{
    ...
    lcd_show_string(30, 70, 200, 16, 16, "MOTION DETECTION TEST", RED);
    ...
    /* enable ai */
    while (esp_motion_detection_ai_strat())
    {
        lcd_show_string(30, 110, 200, 16, 16, "Create Task/Queue Fail!", BLUE);
        /* disable ai */
        esp_motion_detection_ai_deinit();
        vTaskDelay(500);
    }

    while (1)
    {
        lcd_motion_detection_camera(42,0);
