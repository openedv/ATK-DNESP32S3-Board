 ...
 * @file        main.c
 * @author      ALIENTEK
 * @brief       face recongnition example
...
#include "lcd.h"
#include "nvs_flash.h"
#include "esp_face_recognition.hpp"
 ...
 * @retval      None
 */
void lcd_human_recognition_camera(uint16_t x, uint16_t y)
{
...
void app_main(void)
{
    ...
    lcd_show_string(30, 70, 200, 16, 16, "FACED RECOGNITION TEST", RED);
    ...
    /* enable ai */
    while (esp_face_recognition_ai_strat())
    {
    ...
    while (1)
    {
        lcd_human_recognition_camera(42,0);
