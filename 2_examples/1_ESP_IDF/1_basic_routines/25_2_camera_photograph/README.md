...
The hardware is consistent with the **canera example**, and will not be described in detail here:
...
- Using VS Code to open the 25_2_camera_photograph example
