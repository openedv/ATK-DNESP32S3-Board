## Static_task_creation_and_deletion example

### 1 Brief

The main function of this code is to learn task creation and deletion by static method.
...
- Using VS Code to open the 02_Static_task_creation_and_deletion example
