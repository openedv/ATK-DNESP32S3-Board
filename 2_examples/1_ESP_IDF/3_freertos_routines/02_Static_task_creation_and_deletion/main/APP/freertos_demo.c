 ...
 * @author      ALIENTEK
 * @brief       static_task_creation_and_deletion example
 ...
 * include: Task handle,Task Priority,Task stack,Stack size,Create a task function,Task control block
 */
#define TASK1_PRIO      1                   
...
void freertos_demo(void)
{
    ...
    /* Create Task 1 */
    Task1Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task1,         /* task function */
                                                      (const char*      )"task1",       /* task name */
                                                      (uint32_t         )TASK1_STK_SIZE,/* task stack size */
                                                      (void*            )NULL,          /* task function parameters */
                                                      (UBaseType_t      )TASK1_PRIO,    /* task priority */
                                                      (StackType_t*     )Task1TaskStack,/* task stack */
                                                      (StaticTask_t*    )&Task1TaskTCB, /* task control block */
                                                      (BaseType_t       ) 0);           /* kernel runs the task */
    /* Create Task 2 */
    Task2Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task2,         
                                                      (const char*      )"task2",       
                                                      ...
                                                      (BaseType_t       ) 0);           
    /* Create Task 3 */
    Task3Task_Handler = xTaskCreateStaticPinnedToCore((TaskFunction_t   )task3,         
                                                      (const char*      )"task3",       
