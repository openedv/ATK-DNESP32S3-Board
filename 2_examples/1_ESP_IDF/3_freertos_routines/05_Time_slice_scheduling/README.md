## Time_slice_scheduling example

### 1 Brief

The main function of this code is to learn time slice scheduling.
...
- Using VS Code to open the 05_Time_slice_scheduling example
