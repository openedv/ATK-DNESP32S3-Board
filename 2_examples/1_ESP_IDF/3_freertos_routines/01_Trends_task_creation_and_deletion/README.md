## Trends_task_creation_and_deletion example

### 1 Brief

The main function of this code is to learn task creation and deletion by dynamic method.
...
- Using VS Code to open the 01_Trends_task_creation_and_deletion example
