## Task_notification_simulation_binary_semaphore example

### 1 Brief

The main function of this code is to learn task notification simulation binary semaphore.
...
- Using VS Code to open the 15_Task_notification_simulation_binary_semaphore example
