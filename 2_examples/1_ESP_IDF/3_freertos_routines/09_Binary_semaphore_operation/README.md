## Binary_semaphore_operation example

### 1 Brief

The main function of this code is to learn binary semaphore operation.
...
- Using VS Code to open the 09_Binary_semaphore_operation example
