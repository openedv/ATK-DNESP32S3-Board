## Counting_type_semaphore_operation example

### 1 Brief

The main function of this code is to learn counting type semaphore operation.
...
- Using VS Code to open the 10_Counting_type_semaphore_operation example
