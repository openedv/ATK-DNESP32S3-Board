## Insertion_and_deletion_list_items example

### 1 Brief

The main function of this code is to learn list items interposition and deletion.
...
- Using VS Code to open the 04_Insertion_and_deletion_list_items example
