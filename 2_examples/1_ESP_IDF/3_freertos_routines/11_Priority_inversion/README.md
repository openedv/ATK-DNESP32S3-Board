## Priority_inversion example

### 1 Brief

The main function of this code is to learn priority inversion.
...
- Using VS Code to open the 11_Priority_inversion example
...
2. Serial print program execution flow, showing the priority reversal problem caused by semaphore.
